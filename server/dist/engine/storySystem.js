...
exports.getChapterByDay = getChapterByDay;
exports.getEventsByChapter = getEventsByChapter;
exports.getAllEvents = getAllEvents;
exports.getChapterEvents = getChapterEvents;
exports.getMainEvents = getMainEvents;
...
function getChapterByDay(day) {
    for (const chapter of exports.CHAPTERS) {
        if (day >= chapter.dayRange[0] && day <= chapter.dayRange[1]) {
            return chapter;
        }
    }
    // 超过最后一章，返回最后一章
    return exports.CHAPTERS[exports.CHAPTERS.length - 1];
}
/** 获取章节所有事件 */
...
/** 获取指定章节的事件 */
function getChapterEvents(chapter) {
    return ALL_EVENTS.filter(e => e.chapter === chapter);
}
/** 获取指定章节的主线事件 */
function getMainEvents(chapter) {
    return ALL_EVENTS.filter(e => e.chapter === chapter && e.type === 'story');
}
/** 获取指定章节的随机事件 */
function getRandomEvents(chapter) {
    return ALL_EVENTS.filter(e => e.chapter === chapter && e.type !== 'story');
}
/** 根据条件筛选可用事件 */
function getAvailableEvents(chapter, eventHistory) {
